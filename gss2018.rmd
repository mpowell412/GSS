...
The boxchart is a visional aid pointing out that those who believe in the captian punishment are more likely to be gunowners and those who don't believe in the death punishment are not gun owners. 
...
Given the null hypothesis is true only 2 percent of the time, we fail to reject the null hypothesis.
...
The numerical suggest there is no relationship between belife in both the bigbang theory and the afterlife. There is not enough evidence.
...
Given the null hypothesis is true 8 percent of the time, we fail to reject the null hypothesis.
...
The two variable we're looking at are the death penalty (CAPPUN) and race (RACEE), both are factor variables. For this project a barchart will be used for the graphical results and a table1 command for the numerical results.
...
The numerical results poinhts out that the white race are more likely to favor  the death penalty were as the black race are more likey oppose the death penalty than the other races.
